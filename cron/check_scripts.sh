...
then
    ...
    /home/lars/.pyenv/shims/python /home/lars/twitter-kpi/scripts/build_followers.py &
fi
...
#     /home/lars/.pyenv/shims/python /home/lars/twitter-kpi/scripts/new_followers.py &
# fi
...
then
    ...
    /home/lars/.pyenv/shims/python /home/lars/twitter-kpi/scripts/tweet_metrics.py &
fi
